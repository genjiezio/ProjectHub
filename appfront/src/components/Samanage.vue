            ...
            <el-container>
              <el-tabs class="tabs2" type="card">
                <el-tab-pane v-for="(clas, index) in classes"
                  ...
                  <el-button style="margin-left: 90%;" @click="send3(clas.id)">一键提醒</el-button>
                  <el-container>
                    <template>
                      <el-table :data="clas.groupData" border style="width: 100%; margin-left: 120px; margin-top: 2%;">
                        ...
                        <el-table-column fixed="right" label="操作" width="150">
                          <template slot-scope="scope">
                            <el-button @click="look(clas.id, scope.$index)" type="text" size="small">查看</el-button>
                            <el-button @click="lookup(clas.id, scope.$index)" type="text" size="small">评分</el-button>
                            <el-popover
                              placement="right"
                              style="width: auto;"
                              trigger="click">
            ...
            <el-container>
              ...
              <el-tabs class="tabs3" type="card">
                <el-tab-pane v-for="(clas, index) in classes"
                  ...
                  <el-container>
                    <template>
                      <el-table :data="clas.prodata" border style=" margin-left: 5px; width: 60%;">
                            ...
                            prelist: [
                                {
                                    presentationid: 1,
                                    presentationkey: 1,
                                    presentationname: "初期答辩",
                                    presentationtime: [
                                        "2020-03-15 : 10:00 — 12:10",
                                        "2020-03-17 : 14:00 — 15:00"
                                    ]
                                },
                            ],

                            time: '2020-12-31 00:00',
                            proindex: 1,
                            prokey: 1,
                        },
                        ],
